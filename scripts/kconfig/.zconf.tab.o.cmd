cmd_scripts/kconfig/zconf.tab.o := /usr/bin/gcc -Wp,-MD,scripts/kconfig/.zconf.tab.o.d    -D_GNU_SOURCE -I/usr/include/ncursesw -DCURSES_LOC="<ncurses.h>" -DNCURSES_WIDECHAR=1 -DLOCALE  -Iscripts/kconfig -c -o scripts/kconfig/zconf.tab.o scripts/kconfig/zconf.tab.c
